...
<head>
	...
	<title>protein|Functional|Check</title>
	<!--[if lt IE 9]>
		...
		<div class="contents">
			<div class="grid_wrapper">
				...
				<div class="g_12 contents_header">
					<h4 class="i_16_table tab_label"><a href="protein.php">protein</a><a href="funcprotein.php">Analysis</a>><a href="checkprotein.php">Select Function Analysis</a></h4>		
