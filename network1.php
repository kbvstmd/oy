...
<head>
	...
	<title>Functional|Network</title>
	<!--[if lt IE 9]>
...
<iframe frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%" src="http://string-db.org/api/image/network?identifiers=<?php  echo $b; ?>"></iframe>	
