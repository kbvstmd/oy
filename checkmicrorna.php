...
<head>
	...
	<title>microrna|Functional|Check</title>
	<!--[if lt IE 9]>
	...
	<div class="wrapper contents_wrapper">
			...
			<ul class="tab_nav">
				...
				<li class="active_tab i_32_analysis">
					<a href="searchmicrorna.php" title="Kit elements">
		...
		<div class="contents">
			<div class="grid_wrapper">
				...
				<div class="g_12 contents_header">
					<h4 class="i_16_table tab_label"><a href="microrna.php">microrna</a><a href="searchmicrorna.php">Analysis</a>><a href="checkmicrorna.php">Select Function Analysis</a></h4>		
