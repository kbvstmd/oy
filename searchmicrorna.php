	...
	<div class="wrapper contents_wrapper">
		...
		<div class="contents">
			<div class="grid_wrapper">
				...
				<h4 class="i_16_table tab_label"><a href="microrna.php">microrna</a>><a href="searchmicrorna.php">Search</a></h4>		
		...
		<form action="action.php?action=searchgene1" method="post" > 
...
<input type="button"  class="submitIt simple_buttons" value="example" onclick="document.getElementById('sp').value='MIR126\nMIR21\nMIR140\nMIR191\nMIR155\nMIR147A\nMIR29B1\nMIR153-1'" /></br>
MIR126</br>
MIR21</br>
MIR140</br>
MIR191</br>
