	...
	<div class="wrapper contents_wrapper">
		...
		<div class="contents">
			<div class="grid_wrapper">
				...
				<h4 class="i_16_table tab_label"><a href="protein.php">protein</a>><a href="searchprotein.php">Search</a></h4>		
		...
		<form action="action.php?action=searchprotein" method="post" > 
...
<input type="button"  class="submitIt simple_buttons" value="example" onclick="document.getElementById('sp').value='IDO1\nFASLG\nBMP4\nBCL2\nCAPNS1\nCASP3\nAPEX1\nAPP'" /></br>
IDO1</br>
FASLG</br>
BMP4</br>
BCL2</br>
