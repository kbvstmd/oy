...
<head>
	...
	<title>protein|search result</title>
	<!--[if lt IE 9]>
		...
		<div class="contents">
			<div class="grid_wrapper">
				...
				<div class="g_12 contents_header">
					<h4 class="i_16_table tab_label"><a href="protein.php">protein</a>><a href="searchprotein.php">Search</a>><a href="resultprotein.php">Search Result</a></h4>	
...
//3 执行商品查询信息
$sql="SELECT * from molecular_view where {$where}  GROUP BY pubmedID,GeneSymbol ";
