...
<head>
	...
	<title>Functional|Pathway<</title>
	<!--[if lt IE 9]>
		...
		<aside class="sidebar">
			<ul class="tab_nav">
				...
				<li class="i_32_charts">
					<a href="go1.php?ID=<?php echo $a; ?>" title="Visual Data">
			...
			<div class="grid_wrapper">
				...
				<div class="g_12" id="table_wTabs5">
					<div class="widget_header wwOptions">
						...
						<ul class="w_Tabs">
							<li><a href="#table_wTabs-1" title="Tab 1">KEGG</a></li>
							<li><a href="#table_wTabs-2" title="Tab 2">BIOCARTA</a></li>
					...
					<div class="widget_contents noPadding">
						<div id="table_wTabs-1">
							...
							<iframe frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%" src="http://david.abcc.ncifcrf.gov/api.jsp?type=ENTREZ_GENE_ID&ids=<?php echo "{$_GET['ID']}"; ?>&tool=chartReport&annot=KEGG_PATHWAY" target="_blank"></iframe>	
				...
				<iframe frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%" src="http://david.abcc.ncifcrf.gov/api.jsp?type=ENTREZ_GENE_ID&ids=<?php echo "{$_GET['ID']}"; ?>&tool=chartReport&annot=BIOCARTA" target="_blank"></iframe>	
